...
public class ModItems {
    ...
    public static final RegistryObject<Item> ALEXANDRITE_STICK = ITEMS.register("alexandrite_stick",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ALEXANDRITE_SHOVEL = ITEMS.register("alexandrite_shovel",
            () -> new ShovelItem(ModToolTiers.ALEXANDRITE, 1.5f, -2.6F, new Item.Properties()));
    ...
    public static final RegistryObject<Item> EXPLODE_STAFF = ITEMS.register("explode_staff",
            () -> new ExplodeItem(new Item.Properties().fireResistant().durability(900)));
