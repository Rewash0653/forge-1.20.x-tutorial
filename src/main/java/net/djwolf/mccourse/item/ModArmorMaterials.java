...
public enum ModArmorMaterials implements ArmorMaterial {
    ALEXANDRITE("alexandrite", 40, Util.make(new EnumMap<>(ArmorItem.Type.class),
            (p_266655_) -> {
    ...
    private ModArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionTypeMap
            , int enchantmentValue, SoundEvent soundEvent, float toughness, float knockbackRes,
